...
DOCTORS = [
    ...
    {"first": "Sunita", "last": "Kapadia", "specialization": "Cardiologist", "experience": 10,
     "qualification": "MBBS, DM (Cardiology)", "available_days": ["Tue", "Thu", "Sat"],
     "visiting_hours": "10:00 AM - 3:00 PM"},
    {"first": "Rohan", "last": "Bajaj", "specialization": "Cardiologist", "experience": 6,
     "qualification": "MBBS, MD (Cardiology)", "available_days": ["Mon", "Wed", "Fri"],
    ...
    {"first": "Kunal", "last": "Thakur", "specialization": "Dermatologist", "experience": 12,
     "qualification": "MBBS, MD (Dermatology, Venereology & Leprosy)", "available_days": ["Mon", "Wed", "Fri"],
    ...
    {"first": "Pooja", "last": "Agarwal", "specialization": "General Physician", "experience": 6,
     "qualification": "MBBS", "available_days": ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat"],
     "visiting_hours": "5:00 PM - 8:00 PM"},
    {"first": "Deepak", "last": "Chawla", "specialization": "General Physician", "experience": 15,
     "qualification": "MBBS, MD (General Medicine)", "available_days": ["Tue", "Thu", "Sat"],
    ...
    {"first": "Sandeep", "last": "Oberoi", "specialization": "Orthopedic", "experience": 18,
     "qualification": "MBBS, MS (Orthopedics), DNB", "available_days": ["Tue", "Fri", "Sat"],
     "visiting_hours": "10:00 AM - 2:00 PM"},
    # Endocrinologist
    ...
    {"first": "Latha", "last": "Subramaniam", "specialization": "Endocrinologist", "experience": 13,
     "qualification": "MBBS, MD, DM (Endocrinology)", "available_days": ["Mon", "Thu"],
     "visiting_hours": "11:00 AM - 3:00 PM"},
    # Pediatrician
    {"first": "Farah", "last": "Khan", "specialization": "Pediatrician", "experience": 13,
     ...
     "visiting_hours": "10:00 AM - 3:00 PM"},
    {"first": "Arvind", "last": "Pillai", "specialization": "Pediatrician", "experience": 7,
     "qualification": "MBBS, DCH", "available_days": ["Tue", "Thu", "Sat"],
     "visiting_hours": "9:00 AM - 1:00 PM"},
    {"first": "Shalini", "last": "Dsouza", "specialization": "Pediatrician", "experience": 16,
     "qualification": "MBBS, MD (Pediatrics)", "available_days": ["Mon", "Wed", "Fri"],
     "visiting_hours": "4:00 PM - 7:00 PM"},
    # Neurologist
    ...
    {"first": "Nandini", "last": "Krishnamurthy", "specialization": "Neurologist", "experience": 9,
     "qualification": "MBBS, DM (Neurology)", "available_days": ["Mon", "Wed"],
     "visiting_hours": "10:00 AM - 1:00 PM"},
    # Gynecologist
    {"first": "Meenal", "last": "Gupta", "specialization": "Gynecologist", "experience": 15,
     ...
     "visiting_hours": "9:00 AM - 12:00 PM"},
    {"first": "Aarti", "last": "Deshmukh", "specialization": "Gynecologist", "experience": 10,
     "qualification": "MBBS, DGO", "available_days": ["Tue", "Thu", "Sat"],
    ...
    {"first": "Vivek", "last": "Bhatt", "specialization": "ENT Specialist", "experience": 10,
     ...
     "visiting_hours": "3:00 PM - 6:00 PM"},
    {"first": "Rina", "last": "Kohli", "specialization": "ENT Specialist", "experience": 5,
     "qualification": "MBBS, MS (ENT)", "available_days": ["Mon", "Wed", "Fri"],
     "visiting_hours": "9:00 AM - 12:00 PM"},
    # Psychiatrist
    {"first": "Alia", "last": "Malhotra", "specialization": "Psychiatrist", "experience": 12,
     ...
     "visiting_hours": "11:00 AM - 2:00 PM"},
    {"first": "Gaurav", "last": "Saxena", "specialization": "Psychiatrist", "experience": 8,
     "qualification": "MBBS, MD (Psychiatry)", "available_days": ["Mon", "Thu"],
     "visiting_hours": "2:00 PM - 5:00 PM"},
    # Dentist
    ...
    {"first": "Simran", "last": "Bedi", "specialization": "Dentist", "experience": 4,
     "qualification": "BDS", "available_days": ["Sat"],
    ...
    {"first": "Divya", "last": "Rao", "specialization": "Ophthalmologist", "experience": 16,
     ...
     "visiting_hours": "9:00 AM - 1:00 PM"},
    {"first": "Manoj", "last": "Venkatesh", "specialization": "Ophthalmologist", "experience": 11,
     "qualification": "MBBS, MS (Ophthalmology)", "available_days": ["Tue", "Fri"],
     "visiting_hours": "2:00 PM - 5:00 PM"},
]
